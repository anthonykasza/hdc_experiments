...
for feature_row_idx in range(3):
  scatter1 = axs[feature_row_idx][0].scatter(X[:, 0], X[:, feature_row_idx+1], c=predicted_labels, cmap='viridis', marker='o')
  axs[feature_row_idx][0].set_title(f'KBundles, f0:f{feature_row_idx+1}')
  scatter2 = axs[feature_row_idx][1].scatter(X[:, 0], X[:, feature_row_idx+1], c=cluster_labels, cmap='viridis', marker='o')
  axs[feature_row_idx][1].set_title(f'KMeans, f0:f{feature_row_idx+1}')
  scatter3 = axs[feature_row_idx][2].scatter(X[:, 0], X[:, feature_row_idx+1], c=y, cmap='viridis', marker='o')
  axs[feature_row_idx][2].set_title(f'Ground Truth, f0:f{feature_row_idx+1}')
