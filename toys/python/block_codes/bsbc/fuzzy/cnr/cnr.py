...
def bundle(hvs, block_size):
    ...
    kappa = np.abs(z)
    kappa_max = len(kappas) # a block's max kappa is 1.0
    kappa_normalized = kappa / kappa_max
    return mu, kappa_normalized
