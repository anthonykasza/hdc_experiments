# Hypervector elements are coprimes up to dims*dims

# I was looking for a means of representing numbers without self-binding
#  so I was playing with modulo

# What happens when we sample from the coprimes in different ways
...
plt.tight_layout()
plt.savefig('./map_to_coprimes.png')
plt.show()
